...
<div id="Background" class="absolute top-0 w-full h-[430px] rounded-b-[75px] bg-[linear-gradient(180deg,#F2F9E6_0%,#D2EDE4_100%)]"></div>
        <div class="relative flex flex-col gap-[30px] my-[60px] px-5">
                        ...
                        <div class="flex flex-col gap-3 w-full">
                            ...
                            <div class="flex items-center gap-[6px]">
                                ...
                                <p class="text-sm text-ngekos-grey">
                                    {{ \Carbon\Carbon::parse($transaction->start_date)->format('d M Y') }} - {{ \Carbon\Carbon::parse($transaction->start_date)->addMonths($transaction->duration)->format('d M Y') }}
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="flex flex-col gap-[14px]">
                ...
                <a href="#" class="w-full rounded-full p-[14px_20px] text-center font-bold text-white bg-ngekos-black">View My Booking</a>
            </div>
        </div>
@endsection
