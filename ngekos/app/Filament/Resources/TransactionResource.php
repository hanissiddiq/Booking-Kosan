    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('total_amount')->money('idr', true)->label('Total Amount'),
                Tables\Columns\TextColumn::make('transaction_date')->date()->label('Transaction Date'),
            ])
            ->filters([
                //
            ])
